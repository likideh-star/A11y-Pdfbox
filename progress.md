...
- Continue Milestone 6: harden multi-column flow with additional edge cases (mixed element heights, keep-with-next pressure at last column, and cursor reset diagnostics), then proceed to Milestone 7 renderer wiring.
